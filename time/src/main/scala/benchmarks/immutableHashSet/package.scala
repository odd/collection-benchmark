...
class HashSet {
  ...
  @Benchmark
  def subsetOf(bh: Blackhole): Unit = bh.consume(ys.subsetOf(xs))

  @Benchmark
  def equals(bh: Blackhole): Unit = bh.consume(xs == ys)

  @Benchmark
  def incl(bh: Blackhole): Unit = bh.consume(xs + 42)

  @Benchmark
  def excl(bh: Blackhole): Unit = bh.consume(xs - 42)

  @Benchmark
  def union(bh: Blackhole): Unit = bh.consume(xs union ys)

  @Benchmark
  def intersection(bh: Blackhole): Unit = bh.consume(xs intersect ys)
