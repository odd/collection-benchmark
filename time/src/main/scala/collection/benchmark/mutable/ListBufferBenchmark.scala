...
import scala.collection.mutable.{ListBuffer, Seq => MutableSeq}
import org.openjdk.jmh.annotations._
import org.openjdk.jmh.infra.Blackhole

class ListBufferBenchmark extends AbstractBenchmark {
  ...
  val empty: ListBuffer[Long] = ListBuffer.empty[Long]
  var xs: ListBuffer[Long] = _
  var ys: ListBuffer[Long] = _
  var zs: ListBuffer[Long] = _
  var zipped: ListBuffer[(Long, Long)] = _
  var randomIndices: scala.Array[Int] = _
  def fresh(n: Int) = ListBuffer(1L to n.toLong: _*)
  def freshBuilder() = ListBuffer.newBuilder[Long]
