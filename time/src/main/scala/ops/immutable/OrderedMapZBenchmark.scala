...
import scala.collection.immutable.{NumericRange, OrderedMapZ}
...
class OrderedMapZBenchmark {
  //@Param(scala.Array("0", "1", "2", "3", "4", "7", "8", "15", "16", "17", "39", "282", "4096", "131070", "7312102"))
  @Param(scala.Array("1", "7", "4096", "128000"))
  var size: Int = _

  val random = new scala.util.Random(19740115L)
  val empty: OrderedMapZ[Long, Long] = OrderedMapZ.empty[Long, Long]
  var xs: OrderedMapZ[Long, Long] = _
  var zs: OrderedMapZ[Long, Long] = _
  var zipped: OrderedMapZ[Long, (Long, Long)] = _
  var randomIndices: scala.Array[Int] = _
  def fresh(n: Int) = OrderedMapZ((1 to n).map(x => (x.toLong, x.toLong)): _*)
  def freshBuilder() = OrderedMapZ.newBuilder[Long, Long]
