...
import scala.collection.immutable.{NumericRange, VectorMapX}
...
class VectorMapXBenchmark {
  ...
  val empty: VectorMapX[Long, Long] = VectorMapX.empty[Long, Long]
  var xs: VectorMapX[Long, Long] = _
  var zs: VectorMapX[Long, Long] = _
  var zipped: VectorMapX[Long, (Long, Long)] = _
  var randomIndices: scala.Array[Int] = _
  def fresh(n: Int) = VectorMapX((1 to n).map(x => (x.toLong, x.toLong)): _*)
  def freshBuilder() = VectorMapX.newBuilder[Long, Long]
