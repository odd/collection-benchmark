...
import scala.collection.immutable.{NumericRange, OrderedMapX}
...
class OrderedMapXBenchmark {
  //@Param(scala.Array("0", "1", "2", "3", "4", "7", "8", "15", "16", "17", "39", "282", "4096", "131070", "7312102"))
  @Param(scala.Array("1", "7", "4096", "128000"))
  var size: Int = _

  val random = new scala.util.Random(19740115L)
  val empty: OrderedMapX[Long, Long] = OrderedMapX.empty[Long, Long]
  var xs: OrderedMapX[Long, Long] = _
  var zs: OrderedMapX[Long, Long] = _
  var zipped: OrderedMapX[Long, (Long, Long)] = _
  var randomIndices: scala.Array[Int] = _
  def fresh(n: Int) = OrderedMapX((1 to n).map(x => (x.toLong, x.toLong)): _*)
  def freshBuilder() = OrderedMapX.newBuilder[Long, Long]
