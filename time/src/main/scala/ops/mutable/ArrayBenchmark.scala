...
class ArrayBenchmark {
  ...
  val empty: Array[Long] = Array.empty[Long]
  var xs: Array[Long] = _
  var ys: Array[Long] = _
  var zs: Array[Long] = _
  var zipped: Array[(Long, Long)] = _
  var randomIndices: scala.Array[Int] = _
  def fresh(n: Int) = Array(1L to n.toLong: _*)
  def freshBuilder() = Array.newBuilder[Long]

  @Setup(Level.Trial)
  def initTrial(): Unit = {
    xs = fresh(size)
    ys = Array(1L to size.toLong / 2L: _*) ++ Array((size.toLong / 2L) to 1L by -1L: _*)
